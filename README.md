...
This a boilerplate For [Real time private chatting app using Angular Nodejs mongodb and Socket.io](https://github.com/ShankyTiwari/Real-time-private-chatting-app-using-Angular-Nodejs-mongodb-and-Socket.io) repository. This app is private chat application, In which front-end is built-in Angular. 
